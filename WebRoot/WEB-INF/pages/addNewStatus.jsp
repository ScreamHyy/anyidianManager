...
<body>
						...
						$("#frm_info").form("submit", {
						    ...
						    success:function(result){
								...
								if (result.errorMsg) {
									...
									resetValues();
									window.location.href="newStatus";
								}
						    }
						});
					}
	...
	<form id="frm_info" method="post" enctype="multipart/form-data"
		...
		<input type="hidden" name="statusType" value="最新资讯" />
		<input type="hidden" id="image" name="image" value="${status.image}" />
	...
	<div style="margin:8px 8px 16px 8px;">
		<a href="javascript:saveNewStatusInfo();" class="easyui-linkbutton"
