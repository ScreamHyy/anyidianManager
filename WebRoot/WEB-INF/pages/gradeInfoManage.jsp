		...
		$.messager.confirm("系统提示", "您确认要删除这<font color=red>"
			...
			if (r) {
				$.post("gradeDelete", {
					...
					if (result.success) {
						$.messager.alert("系统提示", "您已成功删除" + result.delNums
								+ "条数据");
						$("#dg").datagrid("reload");
					} else {
...
<body style="margin: 5px;">
	<table id="dg" title="班级信息" class="easyui-datagrid" PageSize="20" fitColumns="true" pagination="true" rownumbers="true" url="gradeList" fit="false" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		...
		<div id="dlg" class="easyui-dialog" style="width:400px; heigth:280px; padding:10px 20px;" closed="true" buttons="#dlg-buttons">
			<form id="fm" method="post">
				<table>
					<tr>
						<td>班级名称：</td>
						<td>
							<input type="text" name="gradeName" id="gradeName" class="easyui-validatebox" required="true"></input>
						</td>
					</tr>
					<tr>
