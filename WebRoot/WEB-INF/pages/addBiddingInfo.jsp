...
<body>
						...
						$("#frm_info").form("submit", {
						    ...
						    success:function(result){
								...
								if (result.errorMsg) {
									...
									resetValues();
									window.location.href="biddingInfo";
								}
						    }
						});
					}
	...
	<form id="frm_info" method="post" enctype="multipart/form-data"
		...
		<input type="hidden" name="statusId" value="${status.statusId}" /> <input
			type="hidden" name="statusType" value="招标信息" /> <input type="hidden"
	...
	<div style="margin:8px 8px 16px 8px;">
		<a href="javascript:saveBiddingInfoInfo();" class="easyui-linkbutton"
