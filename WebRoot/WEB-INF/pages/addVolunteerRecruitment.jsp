...
<body>
						...
						$("#frm_info").form("submit", {
						    ...
						    success:function(result){
								...
								if (result.errorMsg) {
									...
									resetValues();
									window.location.href="volunteerRecruitment";
								}
						    }
						});
					}
	...
	<form id="frm_info" method="post" enctype="multipart/form-data"
		...
		<input type="hidden" name="statusId" value="${status.statusId}" /> <input
			type="hidden" name="statusType" value="志愿者新闻" /> <input type="hidden"
	...
	<div style="margin:8px 8px 16px 8px;">
		<a href="javascript:saveVolunteerRecruitmentInfo();" class="easyui-linkbutton"
