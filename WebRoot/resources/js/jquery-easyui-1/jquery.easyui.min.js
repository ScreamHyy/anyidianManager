...
},beforePageText:"页码",afterPageText:" / {pages}",displayMsg:"当前显示第 {from} 至 {to} 条记录，共 {total} 条记录",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"此栏目必填.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,events:{focus:_422,blur:_426,mouseenter:_42a,mouseleave:_42d,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
...
},message:"请填写正确的邮箱地址."},url:{validator:function(_44d){
...
},message:"请填写正确的URL地址."},length:{validator:function(_44e,_44f){
var len=$.trim(_44e).length;
return len>=_44f[0]&&len<=_44f[1];
},message:"输入的字符串长度必须控制在 {0} 至 {1} 之间."},remote:{validator:function(_450,_451){
var data={};
data[_451[1]]=_450;
var _452=$.ajax({url:_451[0],dataType:"json",data:data,async:false,cache:false,type:"post"}).responseText;
return _452=="true";
},message:"请确定此栏目输入是否正确."}},onBeforeValidate:function(){
...
_972(this,q);
}},currentText:"今天",closeText:"关闭",okText:"确认",buttons:[{text:function(_985){
